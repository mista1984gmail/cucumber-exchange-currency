...
public class DataLoader {
    @Bean
    public CommandLineRunner loadData(BankRateRepository bankRateRepository,
        ...
        return (args) -> {
            ...
            //bankRepository.save(new Bank( "PriorBank", bankRates1));
           ...
           // bankRepository.save(new Bank( "Belarusbank", bankRates2));
            ...
            //bankRepository.save(new Bank( "Agroprombank", bankRates3));
        };
    }
}
